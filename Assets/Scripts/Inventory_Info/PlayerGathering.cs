...
public class PlayerGathering : MonoBehaviour
{
    ...
    [Tooltip("Controls how large the stump prefab spawns.")]
    public float stumpScale = 2.5f;
    ...
    bool RemoveNearestTerrainTree(Vector3 worldPoint)
    {
        ...
        TreeInstance removedTree = trees[closestTreeIndex];
        ...
        if (stumpPrefab != null)
        {
            ...
            stump.transform.localScale = Vector3.one * stumpScale;
        }
